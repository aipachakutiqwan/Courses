...
d3=a3-y_matrix;
d2=d3*Theta2(:,2:end).*sigmoidGradient(z2); % review this part
...
%DELTA2=zeros(size(Theta1(:,2:end)));
%DELTA3=zeros(size(Theta2(:,2:end)));
...
%    a3= sigmoid(z3);
    %2
    %[highestvalue,index] = max(a3);
    %a3temp= [1:num_labels]' == index';
%    yv=[1:num_labels]' == y(t)';
%    delta3 = a3 - yv;
    %3
%    delta2= (Theta2(:,2:end))'*delta3.*sigmoidGradient(z2);
    %4
    %DELTA2= DELTA2 + delta2*a1;
%    DELTA2= DELTA2 + delta3*a2';
%    DELTA3= DELTA3 + delta3;
    
%end

%Theta1_grad= Theta1_grad + [ones(hidden_layer_size,1) DELTA2]/m;
%Theta2_grad= Theta2_grad + [ones(num_labels,1) DELTA3]/m;
%Theta2_grad= Theta2_grad + [ones(num_labels,1) DELTA3]/m;
